...
static const char *taunts[7][5] = {
	...
	},
	{
		...
		"Sports-Achiever: You were doing great\n\nuntil I decided to join\n\nthe competition. Better "
		"luck next\n\ntime",

		"Sports-Achiever: Props for trying, but\n\nI think you might need\n\na 'How to Win "
		"Against\n\nYour Superior’",

		"Sports-Achiever: I heard they're making\n\na movie about my sports\n\ntriumphs. Maybe you "
		"can audition\n\nfor the supporting role?",

		"Sports-Achiever: You're like my shadow\n\non the field – always\n\nbehind me. It's a "
		"tough\n\nact to follow, I get\n\nit."
	},
	{
